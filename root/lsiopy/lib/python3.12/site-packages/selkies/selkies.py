...
DEFAULT_STREAM_LOAD_SEND_FPS = 10.0
...
class DataStreamingServer:
    ...
    def _should_preserve_encoded_frame_order(self, display_state):
        return bool(
            display_state
            and display_state.get("dynamic_low_latency_active")
    ...
    def _refresh_low_latency_runtime_tuning(self, display_state):
        ...
        high_load_send_fps = min(
            low_latency_send_fps,
            DEFAULT_STREAM_LOAD_SEND_FPS - (transport_level * 2.5) - (sample_penalty * 3.5),
        )
        if disable_paint_over:
            high_load_send_fps = min(high_load_send_fps, max(1.0, low_latency_send_fps - 1.0))
        ...
        display_state["high_load_send_fps"] = max(1.0, min(display_state["low_latency_send_fps"], high_load_send_fps))
                        ...
                        try:
                            ...
                            if display_id not in self.display_clients:
                                ...
                                self.display_clients[display_id] = {
                                    ...
                                    'high_load_send_fps': DEFAULT_STREAM_LOAD_SEND_FPS,
