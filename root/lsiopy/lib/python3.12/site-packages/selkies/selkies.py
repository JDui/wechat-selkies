...
class DataStreamingServer:
    ...
    def _refresh_low_latency_runtime_tuning(self, display_state):
        ...
        try:
            sample_percent = int(display_state.get("dynamic_low_latency_sample_percent", 60))
        except (TypeError, ValueError):
            sample_percent = 60
        sample_percent = max(33, min(100, sample_percent))
        ...
        bandwidth_percent = min(bandwidth_percent, sample_percent)
                        ...
                        try:
                            ...
                            if display_id not in self.display_clients:
                                ...
                                self.display_clients[display_id] = {
                                    ...
                                    'low_latency_bandwidth_percent': max(10, min(100, int(round((min(15, max(8, int(self.app.framerate))) / max(1, int(self.app.framerate))) * 100.0)))),
